...
import iwir.oerit.bottomnav.AccessibleExploreByTouchHelper
import iwir.oerit.bottomnav.BottomBarItem
import iwir.oerit.bottomnav.BottomBarParser
import iwir.oerit.bottomnav.R
...
class SmoothBottomBar @JvmOverloads constructor(
    ...
    // Attribute Defaults
    @ColorInt
    private var _barBackgroundColor = resources.getColor(R.color.dark_blue)
